...
// terminos y condiciones ------------------
            ...
            'El canal de comunicación que utilizamos se llama “Liveconnect”, una herramienta versátil que integra varios medios de comunicación, incluyendo redes sociales, WhatsApp, correo electrónico y más. Aquí están algunas de sus ventajas: ':'El canal de comunicación que utilizamos se llama “Liveconnect”, una herramienta versátil que integra varios medios de comunicación, incluyendo redes sociales, WhatsApp, correo electrónico y más. Aquí están algunas de sus ventajas: ',
            '• Seguimiento con ID: Cada reclamo o consulta recibe un ID único para asegurar el seguimiento continuo y evitar la pérdida de información.':'• Seguimiento con ID: Cada reclamo o consulta recibe un ID único para asegurar el seguimiento continuo y evitar la pérdida de información.',
            ...
            'Cavaliere Group S.R.L. es propietaria de todos los derechos de propiedad intelectual sobre la Aplicación, contenidos, servicios, productos, marcas, nombres comerciales, logos, diseños, imágenes, frases publicitarias, derechos de autor, dominios, códigos, desarrollos, software, bases de datos, información, tecnología y patentes y modelos de utilidad, diseños, entre otros. Se encuentran protegidos por leyes nacionales e internacionales.':'Cavaliere Group S.R.L. es propietaria de todos los derechos de propiedad intelectual sobre la Aplicación, contenidos, servicios, productos, marcas, nombres comerciales, logos, diseños, imágenes, frases publicitarias, derechos de autor, dominios, códigos, desarrollos, software, bases de datos, información, tecnología y patentes y modelos de utilidad, diseños, entre otros. Se encuentran protegidos por leyes nacionales e internacionales.',
            'El uso de los servicios no implica para el usuario una autorización para utilizar la Propiedad Intelectual.':'El uso de los servicios no implica para el usuario una autorización para utilizar la Propiedad Intelectual.',
            '17. Domicilios y notificaciones: ':'17. Domicilios y notificaciones: ',
            'El domicilio electrónico constituido por el usuario a los fines de la utilización de los servicios es el correo electrónico registrado en la aplicación. Las partes aceptan que todas las notificaciones electrónicas que se cursen a través de la aplicación y/o al correo electrónico registrado serán válidas y vinculantes.':'El domicilio electrónico constituido por el usuario a los fines de la utilización de los servicios es el correo electrónico registrado en la aplicación. Las partes aceptan que todas las notificaciones electrónicas que se cursen a través de la aplicación y/o al correo electrónico registrado serán válidas y vinculantes.',
            '18. Resolución de conflictos: ':'18. Resolución de conflictos: ',
            'Jurisdicción y ley aplicable. Los Términos y Condiciones se encuentran regidos sin excepción y en todos sus puntos por las leyes de la República Argentina y serán interpretados de acuerdo con ellas.':'Jurisdicción y ley aplicable. Los Términos y Condiciones se encuentran regidos sin excepción y en todos sus puntos por las leyes de la República Argentina y serán interpretados de acuerdo con ellas.',


            //----------- Privacidad
            'Política de Privacidad de Megapix':'Política de Privacidad de Megapix',
            'Última actualización: [Fecha actualizada] ':'Última actualización: [Fecha actualizada] ',
            '1. Datos Personales Recopilados. ':'1. Datos Personales Recopilados. ',
            'Megapix recopila los siguientes datos personales: ':'Megapix recopila los siguientes datos personales: ',
            '• Nombre, apellido, domicilio, nacionalidad, teléfono, correo electrónico, CUIT o CUIL, datos de cuenta y contraseñas.':'• Nombre, apellido, domicilio, nacionalidad, teléfono, correo electrónico, CUIT o CUIL, datos de cuenta y contraseñas.',
            '• Información transaccional sobre solicitudes, operaciones y compras.':'• Información transaccional sobre solicitudes, operaciones y compras.',
            '• Datos patrimoniales y financieros, información crediticia, declaración sobre el origen de fondos, prevención de fraude.':'• Datos patrimoniales y financieros, información crediticia, declaración sobre el origen de fondos, prevención de fraude.',
            '• Datos recopilados mediante cookies y tecnologías similares.':'• Datos recopilados mediante cookies y tecnologías similares.',
            '• Datos personales publicados en redes sociales.':'• Datos personales publicados en redes sociales.',
            '2. Uso de Datos Personales. ':'2. Uso de Datos Personales. ',
            'Los datos personales se utilizan para: ':'Los datos personales se utilizan para: ',
            '• Identificar y contactar al usuario.':'• Identificar y contactar al usuario.',
            '• Prestar servicios y procesar transacciones.':'• Prestar servicios y procesar transacciones.',
            '• Responder consultas y proporcionar soporte.':'• Responder consultas y proporcionar soporte.',
            '• Mejorar servicios y funcionalidades del sitio web.':'• Mejorar servicios y funcionalidades del sitio web.',
            '• Enviar comunicaciones de marketing.':'• Enviar comunicaciones de marketing.',
            '• Cumplir con obligaciones legales.':'• Cumplir con obligaciones legales.',
            '3. Seguridad.':'3. Seguridad.',
            'Hemos implementado medidas de seguridad diseñadas para proteger su información contra pérdidas accidentales y frente al acceso, uso, alteración o divulgación. Sin embargo, no podemos garantizar que personas no autorizadas no obtendrán acceso a su información, y usted reconoce que usted proporciona su información a su propio riesgo, salvo las excepciones establecidas por la ley aplicable. Los servicios y/o los productos provistos por Nosotros en el Sitio solo pueden ser dispuestos por personas que tengan la capacidad legal para contratar y/o ser contratados según la legislación aplicable. Los Usuarios que se registren en el Sitio como personas jurídicas deberán tener capacidad suficiente para contratar en nombre de ellas y de obligar a la misma en los presentes Términos y Condiciones. Nosotros no tenemos la obligación de verificar que los Usuarios tengan derecho o capacidad para utilizar el Sitio.':'Hemos implementado medidas de seguridad diseñadas para proteger su información contra pérdidas accidentales y frente al acceso, uso, alteración o divulgación. Sin embargo, no podemos garantizar que personas no autorizadas no obtendrán acceso a su información, y usted reconoce que usted proporciona su información a su propio riesgo, salvo las excepciones establecidas por la ley aplicable. Los servicios y/o los productos provistos por Nosotros en el Sitio solo pueden ser dispuestos por personas que tengan la capacidad legal para contratar y/o ser contratados según la legislación aplicable. Los Usuarios que se registren en el Sitio como personas jurídicas deberán tener capacidad suficiente para contratar en nombre de ellas y de obligar a la misma en los presentes Términos y Condiciones. Nosotros no tenemos la obligación de verificar que los Usuarios tengan derecho o capacidad para utilizar el Sitio.',
            '4. Uso de Cookies.':'4. Uso de Cookies.',
            'Megapix puede utilizar cookies para mejorar la calidad de la visita al sitio web. Las cookies permiten recordar credenciales de inicio de sesión, entender las partes más populares del sitio web y adaptar la experiencia del usuario.':'Megapix puede utilizar cookies para mejorar la calidad de la visita al sitio web. Las cookies permiten recordar credenciales de inicio de sesión, entender las partes más populares del sitio web y adaptar la experiencia del usuario.',
            '5. Enlaces a Sitios Externos.':'5. Enlaces a Sitios Externos.',
            'Megapix puede enlazar a sitios de terceros, pero no es responsable por sus prácticas de seguridad y privacidad. Los usuarios deben revisar las políticas de privacidad de esos sitios.':'Megapix puede enlazar a sitios de terceros, pero no es responsable por sus prácticas de seguridad y privacidad. Los usuarios deben revisar las políticas de privacidad de esos sitios.',
            '6. Modificaciones de la Política de Privacidad.':'6. Modificaciones de la Política de Privacidad.',
            'Megapix puede modificar esta política en cualquier momento. Los cambios significativos serán notificados a los usuarios y se actualizará la fecha de Última actualización.':'Megapix puede modificar esta política en cualquier momento. Los cambios significativos serán notificados a los usuarios y se actualizará la fecha de Última actualización.',
            '7. Derechos del Usuario.':'7. Derechos del Usuario.',
            'Los usuarios tienen derecho a acceder, rectificar o eliminar sus datos personales. Megapix eliminará los datos cuando ya no sean necesarios, salvo obligaciones legales que requieran su conservación. Este documento está adaptado a la legislación argentina, considerando la Ley de Protección de Datos Personales (Ley 25.326) y a instrumentos internacionales.':'Los usuarios tienen derecho a acceder, rectificar o eliminar sus datos personales. Megapix eliminará los datos cuando ya no sean necesarios, salvo obligaciones legales que requieran su conservación. Este documento está adaptado a la legislación argentina, considerando la Ley de Protección de Datos Personales (Ley 25.326) y a instrumentos internacionales.',

            //----- adicionales
            'Términos y Condiciones Particulares “Pagos con PIX”':'Términos y Condiciones Particulares “Pagos con PIX”',
            '1. Definiciones.':'1. Definiciones.',
            'Megapix destaca en la innovación de procesos de cobros y pagos globales, siendo líder en eficiencia. Se acopla al sistema PIX, facilitando pagos sin restricciones a comerciantes argentinos y turistas brasileños. En resumen, Megapix facilita oportunidades de pago global y experiencias únicas. “PIX”: es un sistema de pago instantáneo desarrollado por el Banco Central de Brasil, utilizado por Megapix para procesar transacciones entre turistas brasileños y comerciantes argentinos.':'Megapix destaca en la innovación de procesos de cobros y pagos globales, siendo líder en eficiencia. Se acopla al sistema PIX, facilitando pagos sin restricciones a comerciantes argentinos y turistas brasileños. En resumen, Megapix facilita oportunidades de pago global y experiencias únicas. “PIX”: es un sistema de pago instantáneo desarrollado por el Banco Central de Brasil, utilizado por Megapix para procesar transacciones entre turistas brasileños y comerciantes argentinos.',
            '2. Uso del Sistema Megapix.':'2. Uso del Sistema Megapix.',
            '• ¿Qué es la tecnología PIX? Pix es un sistema de pagos instantáneos desarrollado por el Banco Central de Brasil, que se ha convertido en una solución revolucionaria en el ámbito financiero del país. Fue lanzado en noviembre de 2020 con el objetivo de modernizar el sistema de pagos, reducir costos y fomentar la inclusión financiera.':'• ¿Qué es la tecnología PIX? Pix es un sistema de pagos instantáneos desarrollado por el Banco Central de Brasil, que se ha convertido en una solución revolucionaria en el ámbito financiero del país. Fue lanzado en noviembre de 2020 con el objetivo de modernizar el sistema de pagos, reducir costos y fomentar la inclusión financiera.',
            '• ¿Cómo Megapix absorve e implementa la tecnología? Pix tiene la particularidad de digitalizar los Pesos/Fiat, haciendo un pasaje de la moneda a crypto. En Megapix aprovechamos esa conversión para beneficiar a los Argentinos en el intercambio de productos y servicios con Brasileros, esto quiere decir que toda persona física o jurídica que desee brindar un servicio cobrar en reales y recibir pesos ARS o Crypto puede hacerlo. Este no es el único beneficio, hoy nuestro target (usuarios objetivo) son dos, por un lado los turistas Brasileros que le brindamos el pago inmediato sin la necesidad de ir a casas de cambio y manejar dinero en efectivo. Por el otro lado favorecemos el aumento de ingresos instantaneos brindando que la conversión de los reales que se van a recibir y poder retener en una cuenta como USDT (moneda crypto al valor del dolar preestablecida como moneda digital principal), esto facilita el ahorro en una moneda estable pudiendo retirar y aumentar la ganancia según el crecimiento del valor del dolar, este es un proceso que el usuario debe decidir si mantener o retirar en pesos Argentinos o crypto a travez de cuentas bancarias o billeteras digitales de su preferencia.':'• ¿Cómo Megapix absorve e implementa la tecnología? Pix tiene la particularidad de digitalizar los Pesos/Fiat, haciendo un pasaje de la moneda a crypto. En Megapix aprovechamos esa conversión para beneficiar a los Argentinos en el intercambio de productos y servicios con Brasileros, esto quiere decir que toda persona física o jurídica que desee brindar un servicio cobrar en reales y recibir pesos ARS o Crypto puede hacerlo. Este no es el único beneficio, hoy nuestro target (usuarios objetivo) son dos, por un lado los turistas Brasileros que le brindamos el pago inmediato sin la necesidad de ir a casas de cambio y manejar dinero en efectivo. Por el otro lado favorecemos el aumento de ingresos instantaneos brindando que la conversión de los reales que se van a recibir y poder retener en una cuenta como USDT (moneda crypto al valor del dolar preestablecida como moneda digital principal), esto facilita el ahorro en una moneda estable pudiendo retirar y aumentar la ganancia según el crecimiento del valor del dolar, este es un proceso que el usuario debe decidir si mantener o retirar en pesos Argentinos o crypto a travez de cuentas bancarias o billeteras digitales de su preferencia.',
            '• ¿Cómo es el paso a paso de su uso?':'• ¿Cómo es el paso a paso de su uso?',
            '1. Para poder iniciar el proceso primero deben existir personas físicas o jurídicas registradas en Megapix, su cuenta debe ser validada con la documentación de respaldo necesaria.':'1. Para poder iniciar el proceso primero deben existir personas físicas o jurídicas registradas en Megapix, su cuenta debe ser validada con la documentación de respaldo necesaria.',
            '2. El usuario debe ingresar a la sección “Cobro” y dependiendo el producto servicio ingresar (Monto y motivo) el usuario va a poder seleccionar la moneda a cobrar y automáticamente se le mostrara la conversión en las dos monedas restantes (ARS/BRL/USDT),':'2. El usuario debe ingresar a la sección “Cobro” y dependiendo el producto servicio ingresar (Monto y motivo) el usuario va a poder seleccionar la moneda a cobrar y automáticamente se le mostrara la conversión en las dos monedas restantes (ARS/BRL/USDT),',
            '3. Cuando el cobrador genera el QR el cliente va a pagar con cualquier cuenta bancaria / billetera virtual de su preferencia, lo que debe hacer es escanear el QR y presionar pagar, de manera muy rápida por detrás sin que el usuario se entere se envía la solicitud de pago al banco/billetera, en el caso de ser aprobado. El banco al aprobar envía el pago a nuestro partner de onramp que convierte los BRL a USDT y los transfiere al siguiente partner de offramp que nos brinda la cuenta donde el usuario va a poder conservar y tomar decisiones de que hacer con ese monto.':'3. Cuando el cobrador genera el QR el cliente va a pagar con cualquier cuenta bancaria / billetera virtual de su preferencia, lo que debe hacer es escanear el QR y presionar pagar, de manera muy rápida por detrás sin que el usuario se entere se envía la solicitud de pago al banco/billetera, en el caso de ser aprobado. El banco al aprobar envía el pago a nuestro partner de onramp que convierte los BRL a USDT y los transfiere al siguiente partner de offramp que nos brinda la cuenta donde el usuario va a poder conservar y tomar decisiones de que hacer con ese monto.',
            '4. La integración para la provisión del Servicio está provista por SmartPay y Manteca.':'4. La integración para la provisión del Servicio está provista por SmartPay y Manteca.',
            '3. Límites. ':'3. Límites. ',
            'El servicio estará habilitado para operaciones con un monto mínimo y máximo, de acuerdo a los límites informados en la Aplicación. La aprobación de las transacciones se encuentra sujeta a verificación de límites operativos establecidos por los operadores, instituciones de pago involucradas, organismos regulatorias y disponibilidad y suficiencia de fondos del usuario.':'El servicio estará habilitado para operaciones con un monto mínimo y máximo, de acuerdo a los límites informados en la Aplicación. La aprobación de las transacciones se encuentra sujeta a verificación de límites operativos establecidos por los operadores, instituciones de pago involucradas, organismos regulatorias y disponibilidad y suficiencia de fondos del usuario.',
            '4. Comisiones. ':'4. Comisiones. ',
            'El uso del Servicio podrá estar sujeto a comisiones. En caso de aplicar, estas serán informadas en la Aplicación.':'El uso del Servicio podrá estar sujeto a comisiones. En caso de aplicar, estas serán informadas en la Aplicación.',
            '5. Obligaciones fiscales y legales. ':'5. Obligaciones fiscales y legales. ',
            'El Usuario será responsable por todas las obligaciones y cargas impositivas que correspondan por sus operaciones en el Sitio, sin que pueda imputarse a Megapix ningún tipo de responsabilidad derivada de los incumplimientos de El Usuario.':'El Usuario será responsable por todas las obligaciones y cargas impositivas que correspondan por sus operaciones en el Sitio, sin que pueda imputarse a Megapix ningún tipo de responsabilidad derivada de los incumplimientos de El Usuario.',
            '6. Saldos de los usuarios. ':'6. Saldos de los usuarios. ',
            'Nosotros no estamos autorizados por el Banco Central de la República Argentina para operar como una entidad financiera en los términos de la Ley Nº 21.526. Por ende los fondos depositados en las cuentas de Megapix no constituyen depósitos en una entidad financiera regulada y no cuentan con las garantías de depósitos en entidades financieras. A diferencia de esas entidades, Megapix no presta depósitos de sus usuarios.':'Nosotros no estamos autorizados por el Banco Central de la República Argentina para operar como una entidad financiera en los términos de la Ley Nº 21.526. Por ende los fondos depositados en las cuentas de Megapix no constituyen depósitos en una entidad financiera regulada y no cuentan con las garantías de depósitos en entidades financieras. A diferencia de esas entidades, Megapix no presta depósitos de sus usuarios.',
            '7. Retiros. ':'7. Retiros. ',
            'El Usuario tiene la posibilidad de retirar, en forma total o parcial, el saldo existente en su cuenta para transferirlo directamente a su cuenta bancaria o billetera virtual. Nosotros no somos responsables de las cargas impositivas o comisiones bancarias de la cuenta receptora.':'El Usuario tiene la posibilidad de retirar, en forma total o parcial, el saldo existente en su cuenta para transferirlo directamente a su cuenta bancaria o billetera virtual. Nosotros no somos responsables de las cargas impositivas o comisiones bancarias de la cuenta receptora.',
            'Respecto al retiro en billeteras virtuales personales de los Usuarios, se hace saber que el costo que implique cada transacción será afrontado por el Usuario. Dicho monto será variable y dependerá del tráfico de la red. En el caso de que el Usuario no proporcionare una cuenta bancaria válida, habilitada, o la misma fuese proporcionada con un número de cuenta incorrecto o incompleto, moneda de la cuenta errónea, o cualquier otro motivo que imposibilitara el correcto procedimiento de la operación, el retiro no podrá ejecutarse hasta tanto se cumplimente con los requisitos necesarios.':'Respecto al retiro en billeteras virtuales personales de los Usuarios, se hace saber que el costo que implique cada transacción será afrontado por el Usuario. Dicho monto será variable y dependerá del tráfico de la red. En el caso de que el Usuario no proporcionare una cuenta bancaria válida, habilitada, o la misma fuese proporcionada con un número de cuenta incorrecto o incompleto, moneda de la cuenta errónea, o cualquier otro motivo que imposibilitara el correcto procedimiento de la operación, el retiro no podrá ejecutarse hasta tanto se cumplimente con los requisitos necesarios.',
            'Nosotros no seremos responsables ante el caso de que el Usuario se encuentre momentáneamente imposibilitado de hacer retiro de sus fondos porque el banco destinatario solicitara información, documentación complementaria, o por cualquier tipo de motivo cursado por el banco destinatario. El Usuario es el único responsable en la relación contractual que mantiene con la entidad bancaria o billetera virtual a la que envía sus fondos a retirar.':'Nosotros no seremos responsables ante el caso de que el Usuario se encuentre momentáneamente imposibilitado de hacer retiro de sus fondos porque el banco destinatario solicitara información, documentación complementaria, o por cualquier tipo de motivo cursado por el banco destinatario. El Usuario es el único responsable en la relación contractual que mantiene con la entidad bancaria o billetera virtual a la que envía sus fondos a retirar.',
            'No se ejecuta retención indebida cuando el Usuario desea ejecutar un retiro y su perfil se encuentra inhabilitado por estar incompleto o por alguna causal de suspensión. Nosotros no nos responsabilizamos por el destino de los activos digitales. Nos reservamos el derecho de inmovilizar los saldos de cuenta e impedir la transferencia al Usuario y/o a terceros por parte de los Usuarios en caso de ser cursado cualquier tipo de requerimiento judicial o agencia gubernamental que así lo exigiera.':'No se ejecuta retención indebida cuando el Usuario desea ejecutar un retiro y su perfil se encuentra inhabilitado por estar incompleto o por alguna causal de suspensión. Nosotros no nos responsabilizamos por el destino de los activos digitales. Nos reservamos el derecho de inmovilizar los saldos de cuenta e impedir la transferencia al Usuario y/o a terceros por parte de los Usuarios en caso de ser cursado cualquier tipo de requerimiento judicial o agencia gubernamental que así lo exigiera.',
            'El Usuario declara tener conocimiento de que deberá ser titular de la cuenta bancaria a la que se envíe el retiro de sus fondos. Es decir, el titular de la cuenta bancaria de retiro deberá ser el mismo que el titular de la cuenta de depósito.':'El Usuario declara tener conocimiento de que deberá ser titular de la cuenta bancaria a la que se envíe el retiro de sus fondos. Es decir, el titular de la cuenta bancaria de retiro deberá ser el mismo que el titular de la cuenta de depósito.',
            '8. Transacciones en criptomonedas. ':'8. Transacciones en criptomonedas. ',
            'Procesaremos, en carácter de intermediarios, actuando por cuenta y orden de los Usuarios, la ejecución de los cobros por medio de compra y venta de moneda fiduciaria y de activos virtuales de acuerdo con las instrucciones que recibamos de usted y para lo cual, aceptando estos Términos y Condiciones, nos otorga un mandato específico a los fines descriptos. Podrán ser utilizados para la ejecución de estos servicios distintos proveedores habilitados para los mismos.':'Procesaremos, en carácter de intermediarios, actuando por cuenta y orden de los Usuarios, la ejecución de los cobros por medio de compra y venta de moneda fiduciaria y de activos virtuales de acuerdo con las instrucciones que recibamos de usted y para lo cual, aceptando estos Términos y Condiciones, nos otorga un mandato específico a los fines descriptos. Podrán ser utilizados para la ejecución de estos servicios distintos proveedores habilitados para los mismos.',
            'Consentimiento. Al aceptar los presentes términos y condiciones, el usuario presta su conformidad para que los pagos efectuados bajo la operatoria “Pagos con Pix” sean descontados de su balance general.':'Consentimiento. Al aceptar los presentes términos y condiciones, el usuario presta su conformidad para que los pagos efectuados bajo la operatoria “Pagos con Pix” sean descontados de su balance general.',
            '9. Declaraciones. ':'9. Declaraciones. ',
            'El usuario declara que utilizará los servicios de forma lícita.':'El usuario declara que utilizará los servicios de forma lícita.',
            '10. Datos Personales. ':'10. Datos Personales. ',
            'Se aplicará lo dispuesto en la Política de Privacidad.':'Se aplicará lo dispuesto en la Política de Privacidad.',
            '11. Seguridad y Responsabilidad. ':'11. Seguridad y Responsabilidad. ',
            'El usuario registrado será el único responsable por el uso del servicio y las operaciones realizadas en la aplicación. Entiende que en caso de pérdida, vulnerabilidad, robo y/o filtración de la información de acceso a su cuenta, es exclusivamente el usuario quien será responsable por las pérdidas y perjuicios que esto le pudiera ocasionar.':'El usuario registrado será el único responsable por el uso del servicio y las operaciones realizadas en la aplicación. Entiende que en caso de pérdida, vulnerabilidad, robo y/o filtración de la información de acceso a su cuenta, es exclusivamente el usuario quien será responsable por las pérdidas y perjuicios que esto le pudiera ocasionar.',
    ...
    br: {
        translation: {
            ...
            'Integración con API':'Integração com API',
            'Ofrecemos una integración ágil y eficiente para comerciantes y empresas con sistemas propios. Mediante nuestra API, podrán incorporar de forma simple y rápida las funcionalidades de Megapix en su plataforma. Esto asegura una experiencia fluida, adaptada a sus necesidades, y optimiza el proceso de pago dentro de su propio entorno.':'Oferecemos uma integração ágil e eficiente para comerciantes e empresas com sistemas próprios. Através da nossa API, poderão incorporar de forma simples e rápida as funcionalidades da Megapix em sua plataforma. Isso garante uma experiência fluida, adaptada às suas necessidades, e otimiza o processo de pagamento dentro do seu próprio ambiente.',
            //Pagos inmediatos
...
"Términos y condiciones adicionales":"Termos e condições adicionais",
    ...
    en: {
        translation: {
            ...
            'Integración con API':'API Integration',
            'Ofrecemos una integración ágil y eficiente para comerciantes y empresas con sistemas propios. Mediante nuestra API, podrán incorporar de forma simple y rápida las funcionalidades de Megapix en su plataforma. Esto asegura una experiencia fluida, adaptada a sus necesidades, y optimiza el proceso de pago dentro de su propio entorno.':'We offer an agile and efficient integration for merchants and businesses with their own systems. Through our API, they can easily and quickly incorporate Megapix functionalities into their platform. This ensures a smooth experience tailored to their needs and optimizes the payment process within their own environment.',
            //Pagos inmediatos
...
// TURISTAS ------------------
            ...
            "Términos y condiciones adicionales":"Additional terms and conditions",
