        ...
        <div className='containerCard'>
            <div className='card'>
                <div className='textCardFirst'>
                    <p className='textCard'>Más del 30% de los turistas que visitan Argentina son brasileños, y miles más residen y comercian en el país en destinos como Buenos Aires, Ushuaia, Bariloche, Mendoza y Misiones. Aprovechá esta oportunidad y conectá tu negocio con ellos.</p>
